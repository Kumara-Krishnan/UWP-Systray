...
namespace SystrayComponent
{
    class SystrayApplicationContext : ApplicationContext
    {
        ...
        {
            MenuItem executeDomainLogic = new MenuItem("Perform domain logic", new EventHandler(PerformDomainLogic));
        ...
        private void PerformDomainLogic(object sender, EventArgs e)
        {
            try
            {
